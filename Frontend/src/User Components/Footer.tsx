...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-900 text-white border-0">
      <div className="max-w-7xl mx-auto px-6 py-12 border-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border-0">
          {/* Company Info */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/new" className="text-gray-400 hover:text-blue-400 transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact-us" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-1 shrink-0 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 shrink-0 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@sangamayurvedic.com" className="text-sm hover:text-blue-400 transition-colors">
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border-0 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                />
