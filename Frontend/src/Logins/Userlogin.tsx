          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors pr-11"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-green-600 rounded-lg font-medium text-green-600 bg-white hover:bg-green-50 transition-colors duration-300"
              >
